...
class EnergyMeter extends StatelessWidget {
  ...
  const EnergyMeter({Key? key, required this.size, required this.meterModel}) : super(key: key);
                  ...
                  children: [
                    ...
                    Text('${meterModel.vAvg} V',
                        style: GoogleFonts.getFont(
                          'Quantico',
                          textStyle: const TextStyle(color: Colors.white, fontSize: 16.0, fontWeight: FontWeight.w600),
                        )),
                  ],
                ),
                const SizedBox(height: 10.0),
